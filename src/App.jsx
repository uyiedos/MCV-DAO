...
const App = () => {
  ...
  const { contract: token } = useContract("0x6CE8913B8139B44ea43C2509b0eEf03835fF6345", "token");
...
if (!address) {
  return (
    <div className="landing">
      <h1>Welcome to MCVDAO, where fom meets you</h1>
...
return (
    <div className="mint-nft">
      <h1>Mint your Membership NFT</h1>
      <div className="btn-hero">
        <Web3Button
